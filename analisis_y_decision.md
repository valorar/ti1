...
- **Placa controladora programable en MicroPython.** El programa propone ESP32 —Wi-Fi integrado, que es lo que hace viable el Tema 16 sin módulos añadidos— pero no cierra la decisión: los temas 14, 16, 18 y 19 se redactan de modo que puedan impartirse igualmente con Raspberry Pi Pico W o con micro:bit, y la elección concreta queda al criterio del departamento y al material disponible. Lo que sí se fija es el lenguaje textual, para no partir el curso en dos sintaxis distintas.

...
BLOQUES = [
 ...
 ("bloque_e", "Bloque E", "Sistemas informáticos. Programación",
  "Desde los primeros programas en Python con Jupyter Notebook hasta las estructuras de control, la modularización, la depuración y la conexión de dispositivos.",
  [(12, "Fundamentos de la programación textual: del problema al programa",
   ...
   (14, "Estructuras de control y estructuras de datos",
      "Cómo decide y cómo repite un programa, y cómo se guardan muchos datos en una sola variable."),
   (15, "Proceso de desarrollo: modularización, pruebas y depuración",
      "Cómo se organiza, se comprueba y se corrige un programa que crece, y qué ocurre entre el código fuente y su ejecución."),
 ...
 ("bloque_g", "Bloque G", "Tecnología sostenible",
  ...
  [(20, "Fuentes de energía, sistemas y mercados energéticos",
   ...
   (22, "Climatización, domótica, arquitectura sostenible y eficiencia energética",
      "Cómo se acondiciona una vivienda gastando lo menos posible y qué papel juegan el aislamiento, la domótica y las renovables.")]),
]
